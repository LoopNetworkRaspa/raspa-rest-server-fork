...
class RaspadInfoResponse(BaseModel):
    mempoolSize: str = "1"
...
@app.get("/info/raspad", response_model=RaspadInfoResponse, tags=["Raspa network info"])
async def get_raspad_info():
    """
    Get some information for raspad instance, which is currently connected.
    """
