...
@app.get("/info/hashrate", response_model=HashrateResponse | str, tags=["Raspa network info"])
...
@app.get("/info/hashrate/max", response_model=MaxHashrateResponse, tags=["Raspa network info"])
@sql_db_only
