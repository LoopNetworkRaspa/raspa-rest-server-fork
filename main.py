...
async def startup():
    ...
    if IS_SQL_DB_CONFIGURED:
        await create_all(drop=DROP_SQL_DB)
    # get kaspad
...
logging.basicConfig(
    ...
    level=(
        ...
        else logging.INFO and print("DEBUG: ---- INFO")
    ),
...
# pipenv run uvicorn main:app --reload --host 0.0.0.0 --port 8080 // use this command to run the server
